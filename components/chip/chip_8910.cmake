...
function(pacvariant_gen)
	...
	if(CONFIG_QUEC_PROJECT_FEATURE_PROG_FW_FMTSYS)   # quectel modify
		...
		cfg-erase-flash -i ERASE_BOOT -a ${CONFIG_BOOT_FLASH_ADDRESS} -s ${CONFIG_BOOTLOADER_SIZE}    # quectel modify
                ...
                #cfg-fmt-flash -i FMT_FSSYS -b FSYS -n    # quectel modify
		${cfg_fmt_fssys} # quectel modify
		cfg-phase-check   # quectel modify
                ${cfg_fmt_fext}
                cfg-clear-nv
		...
		cfg-image -i BOOTLOADER -a ${CONFIG_BOOT_FLASH_ADDRESS} -s ${CONFIG_BOOTLOADER_SIZE}
			-p ${out_hex_dir}/boot.sign.img     # quectel modify
