...
enum
{
    QIOT_SUB_DEV_ERR_NO_ASSOCIATION = 10440, /* The gateway is not associated with the sub-device */
    QIOT_SUB_DEV_ERR_ALREADY_CONN = 10441,   /* Sub-device is connected (Connected successfully) */
    QIOT_SUB_DEV_ERR_UNLOGIN = 10442,        /* Device is not logged into Developer Center */
};
