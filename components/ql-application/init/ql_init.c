...
/*Caution:If the macro of secure boot and the function are opened, download firmware and restart will enable secure boot.
    ...
    AutoSwitch_call_app_init();
    AutoSwitch_Uart_app_init();
    AutoSwitch_audio_app_init();
    AutoSwitch_mqtt_app_init();
   // AutoSwitch_pbk_app_init();
    AutoSwitch_nw_app_init();
    ASW_power_app_init();
    AutoSwitch_embed_flash_app_init();
    //AutoSwitch_rtc_app_init();
    ql_usb_app_init();
    //ql_rtc_app_init();
